                    ...
                    <tr class="hover:bg-gray-50/60 transition">
                        ...
                        <td class="py-4 text-right space-x-1 whitespace-nowrap" data-label="İşlem">
                            ...
                            <?php if(in_array($order->status, ['pending', 'failed', 'cancelled'])): ?>
                                <button type="button" onclick="openDeleteOrderModal(<?php echo e($order->id); ?>, 'Sipariş #<?php echo e($order->id); ?> (<?php echo e($order->name); ?>)')" class="py-1.5 px-2.5 bg-rose-50 text-rose-600 hover:bg-rose-100 font-bold text-xs rounded-lg transition inline-flex items-center gap-1">
