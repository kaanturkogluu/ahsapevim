...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Ahşap Evim Manisa — Kişiye Özel El Yapımı Masif Ahşap Çerçeveler'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Manisa\'da masif ahşap el işçiliği ile kişiye özel fotoğraflı dönen ahşap çerçeveler ve hediyelik dekoratif tasarımlar üretiyoruz. Aynı gün kargo imkanıyla hemen sipariş verin.'); ?>">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">

    <!-- Open Graph / Sosyal Medya -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Ahşap Evim Manisa — Kişiye Özel Masif Ahşap Çerçeveler'); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Manisa\'da masif ahşap el işçiliği ile kişiye özel fotoğraflı dönen ahşap çerçeveler ve hediyelik dekoratif tasarımlar üretiyoruz.'); ?>">
    <meta property="og:image" content="<?php echo $__env->yieldContent('meta_image', 'https://ahsapevimmanisa.com/ahsaplogo_org.png'); ?>">
...
<body class="text-gray-800 flex flex-col min-h-screen">
        ...
        <div class="container mx-auto px-4 flex justify-between items-center font-medium">
            ...
            <div class="flex gap-5">
                <?php if(!empty($contactData['phone'])): ?>
                    <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $contactData['phone'])); ?>" class="hover:text-brand transition flex items-center gap-1.5">
                        <i class="fa-solid fa-phone text-amber-700"></i> <?php echo e($contactData['phone']); ?>

                    </a>
                <?php endif; ?>
                <?php if(!empty($contactData['whatsapp'])): ?>
                    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactData['whatsapp'])); ?>" target="_blank"
                ...
                <?php endif; ?>
                <a href="<?php echo e(url('/sikca-sorulanlar')); ?>" class="hover:text-brand transition flex items-center gap-1.5">
    ...
    <header class="bg-[#fffbf5] sticky top-0 z-40 shadow-sm border-b border-amber-100">
        <div class="container mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-5">
            ...
            <div class="flex-1 w-full max-w-2xl relative">
                <form action="<?php echo e(url('/urunler')); ?>" method="GET" id="headerSearchForm" class="relative flex items-center w-full bg-amber-50 border-2 border-amber-100 focus-within:border-brand focus-within:bg-white rounded-xl transition-all">
                    <input type="text" name="q" id="headerSearchInput" value="<?php echo e(request('q') ?: request('search')); ?>" autocomplete="off" oninput="handleLiveSearch(this.value)" placeholder="Ürün, kategori veya tasarım arayın…"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center gap-2 pt-2">
                        ...
                        <?php if(!empty($contactData['whatsapp'])): ?>
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactData['whatsapp'])); ?>" target="_blank" title="WhatsApp Destek" class="w-8 h-8 rounded-xl bg-white border border-gray-200 hover:border-emerald-600 hover:bg-emerald-600 hover:text-white text-gray-600 flex items-center justify-center transition shadow-2xs">
    ...
    <?php if(!empty($contactData['whatsapp'])): ?>
    <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactData['whatsapp'])); ?>" target="_blank" title="WhatsApp İletişim Hattı" class="fixed bottom-5 left-5 z-[9999] w-12 h-12 bg-emerald-500 hover:bg-emerald-600 text-white rounded-full flex items-center justify-center text-2xl shadow-xl hover:scale-110 transition-transform duration-200 border-2 border-white group">
    ...
    function handleLiveSearch(query) {
        ...
        liveSearchTimer = setTimeout(() => {
            fetch('<?php echo e(route("search.live")); ?>?q=' + encodeURIComponent(query))
                .then(res => res.json())
                .then(data => {
