    ...
    <div class="mb-6 pb-4 border-b border-gray-100 flex justify-between items-center">
        <div>
            ...
            <p class="text-xs text-gray-500 mt-1">
                ...
                <?php elseif($page->slug === 'sikca-sorulanlar'): ?>
                ...
                <div class="lg:col-span-8 space-y-4">
                    ...
                    <div class="bg-amber-50/40 p-4 rounded-xl border border-amber-200/70">
                        ...
                        <div id="faqContainer" class="space-y-4">
                            <?php $faqs = old('faqs', $faqItems ?? []); ?>
                            <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="faq-row bg-white p-4 rounded-xl border border-gray-200 shadow-sm relative transition hover:border-amber-300">
                                    <div class="flex items-center justify-between mb-2">
                                        <span class="text-xs font-bold text-amber-700 flex items-center gap-1">
                                            <i class="fa-solid fa-circle-question text-[#C87A53] mr-1"></i> Soru #<span class="faq-number"><?php echo e($index + 1); ?></span>
                                        </span>
                                    ...
                                    <div class="space-y-3">
                                        <div>
                                            ...
                                            <input type="text" name="faqs[<?php echo e($index); ?>][question]" value="<?php echo e($item['question'] ?? ''); ?>" placeholder="Örn: Siparişim ne zaman kargoya verilir?" class="w-full text-xs font-semibold border-gray-300 rounded-lg p-2.5 border focus:border-[#C87A53] focus:ring-0 outline-none">
                                        </div>
                                        <div>
                                            <label class="block text-[11px] font-semibold text-gray-600 mb-1">Cevap Metni</label>
                                            <textarea name="faqs[<?php echo e($index); ?>][answer]" rows="3" placeholder="Sorunun ayrıntılı yanıtı..." class="w-full text-xs border-gray-300 rounded-lg p-2.5 border focus:border-[#C87A53] focus:ring-0 outline-none"><?php echo e($item['answer'] ?? ''); ?></textarea>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-4 space-y-4 lg:sticky lg:top-4">
                    <div class="bg-white p-4 rounded-xl border-2 border-[#C87A53]/30 shadow-sm">
                        ...
                        <div class="space-y-2">
                            ...
                            <a href="<?php echo e(url('/sikca-sorulanlar')); ?>" target="_blank" class="w-full py-2 px-4 bg-gray-100 hover:bg-gray-200 text-gray-700 font-bold rounded-lg text-xs transition flex items-center justify-center gap-2">
                                <i class="fa-solid fa-eye"></i> Sayfayı Önizle
                            </a>
                        </div>
                    </div>
    ...
    <?php else: ?>
        ...
        <form action="<?php echo e(route('admin.pages.update', $page->id)); ?>" method="POST" id="editPageForm">
            ...
            <div class="mb-6">
                ...
                <textarea id="pageContent" name="content" class="hidden"><?php echo old('content', $page->content); ?></textarea>
            </div>
