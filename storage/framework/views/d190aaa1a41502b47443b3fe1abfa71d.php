            ...
            <div class="flex flex-col lg:flex-row gap-8">
                                ...
                                <div class="flex-1 text-center sm:text-left">
                                    ...
                                    <?php if($customImgUrl): ?>
                                        <div class="inline-flex items-center gap-2 bg-amber-50 text-amber-900 border border-amber-200/80 text-xs font-bold px-2.5 py-1 rounded-md mb-2">
                                            ...
                                            <img src="<?php echo e($customImgUrl); ?>" class="w-5 h-5 object-cover rounded border border-amber-300 cursor-pointer" onclick="openCartPreviewModal('<?php echo e($customImgUrl); ?>', 'Yüklenen Fotoğraf')">
                                            <button type="button" onclick="openCartPreviewModal('<?php echo e($customImgUrl); ?>', 'Yüklenen Fotoğraf')" class="text-brand hover:underline font-extrabold ml-1">
                                                (Fotoğrafı İncele)
                                            </button>
                                        </div>
                                    <?php endif; ?>
                ...
                <div class="w-full lg:w-1/4">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                        ...
                        <a href="<?php echo e(route('checkout.index')); ?>" class="w-full bg-[#C87A53] hover:bg-[#A65F38] text-white font-bold py-3.5 px-4 rounded-lg transition text-base shadow-md flex items-center justify-center gap-2">
                            Alışverişi Tamamla
