...
<body class="bg-gray-100 flex h-screen overflow-hidden">
    ...
    <div class="w-64 bg-[#29221C] text-white flex flex-col">
        <div class="p-4 bg-[#1D1713] text-center font-bold text-xl border-b border-[#3D332B]">
            <a href="<?php echo e(route('admin.revenue.index')); ?>" class="text-white hover:text-amber-400 transition">Ahşap Evim Admin</a>
        </div>
        <nav class="flex-1 overflow-y-auto mt-4">
            ...
            <a href="<?php echo e(route('admin.revenue.index')); ?>" class="block p-4 hover:bg-[#3D332B]"><i class="fa-solid fa-chart-line mr-2"></i> Gelir Tablosu</a>
            ...
            <a href="<?php echo e(route('admin.shipping_companies.index')); ?>" class="block p-4 hover:bg-[#3D332B]"><i class="fa-solid fa-truck-fast mr-2"></i> Kargo Şirketleri</a>
            ...
            <a href="<?php echo e(route('admin.mail_logs.index')); ?>" class="block p-4 hover:bg-[#3D332B]"><i class="fa-solid fa-envelope-circle-check mr-2 text-amber-400"></i> E-Posta Logları</a>
            <a href="<?php echo e(route('admin.sms_logs.index')); ?>" class="block p-4 hover:bg-[#3D332B]"><i class="fa-solid fa-comment-sms mr-2 text-[#C87A53]"></i> SMS Logları</a>
