                    ...
                    <div class="bg-amber-50/50 rounded-2xl p-6 mb-8 border border-amber-200/80 text-left space-y-4">
                        ...
                        <?php if(!auth()->check() && $trackingCode): ?>
                            <div class="bg-white p-3.5 rounded-xl border border-amber-200 flex items-center justify-between gap-3 shadow-sm">
                                ...
                                <button type="button" onclick="navigator.clipboard.writeText('<?php echo e($trackingCode); ?>'); alert('Takip kodunuz kopyalandı: <?php echo e($trackingCode); ?>');" class="bg-[#C87A53] hover:bg-[#A65F38] text-white text-xs font-bold py-2 px-3.5 rounded-xl transition shadow-sm flex items-center gap-1.5">
