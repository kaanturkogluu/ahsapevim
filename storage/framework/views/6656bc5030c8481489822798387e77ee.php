<?php $__env->startSection('header', 'Yeni Bilgilendirme Sayfası Ekle'); ?>
...
<div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm max-w-5xl">
    <div class="mb-6 pb-4 border-b border-gray-100 flex justify-between items-center">
        ...
        <a href="<?php echo e(route('admin.pages.index')); ?>" class="text-sm font-bold text-gray-500 hover:text-gray-700 transition">
            <i class="fa-solid fa-arrow-left mr-1"></i> Geri Dön
        </a>
    </div>

    <form action="<?php echo e(route('admin.pages.store')); ?>" method="POST" id="createPageForm">
        <?php echo csrf_field(); ?>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                <label class="block text-sm font-semibold text-gray-700 mb-1">Sayfa Başlığı *</label>
                <input type="text" name="title" required value="<?php echo e(old('title')); ?>" class="w-full text-sm border-gray-300 rounded-lg p-2.5 border focus:border-brand focus:ring-0 outline-none" placeholder="Örn: Kargo ve Teslimat Koşulları">
            </div>
            ...
            <div>
                ...
                <div class="flex items-center">
                    ...
                    <input type="text" name="slug" value="<?php echo e(old('slug')); ?>" class="w-full text-sm border-gray-300 rounded-r-lg p-2.5 border focus:border-brand focus:ring-0 outline-none font-mono" placeholder="örn: kargo-kosullari">
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea id="pageContent" name="content" class="hidden" required><?php echo e(old('content')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cerceve\resources\views/admin/pages/create.blade.php ENDPATH**/ ?>