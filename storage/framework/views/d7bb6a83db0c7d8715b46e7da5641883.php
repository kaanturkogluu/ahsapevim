...
<div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
        ...
        <div class="bg-gradient-to-br from-orange-50 to-white p-5 rounded-2xl border border-orange-100/80 shadow-sm flex items-start gap-4 transition hover:shadow-md">
            ...
            <div>
                ...
                <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', $contactData['phone'] ?? '')); ?>" class="text-lg font-bold text-gray-800 hover:text-[#C87A53] transition block mt-0.5">
                    <?php echo e($contactData['phone'] ?? '0850 XXX XX XX'); ?>
        ...
        <div class="bg-gradient-to-br from-green-50 to-white p-5 rounded-2xl border border-green-100/80 shadow-sm flex items-start gap-4 transition hover:shadow-md">
            ...
            <div>
                ...
                <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $contactData['whatsapp'] ?? '')); ?>" target="_blank" class="text-lg font-bold text-gray-800 hover:text-emerald-600 transition block mt-0.5">
                    <?php echo e($contactData['whatsapp'] ?? '05XX XXX XX XX'); ?>
        ...
        <div class="bg-gradient-to-br from-purple-50 to-white p-5 rounded-2xl border border-purple-100/80 shadow-sm flex items-start gap-4 transition hover:shadow-md">
            ...
            <div>
                ...
                <div class="text-sm font-bold text-gray-800 mt-0.5">
                    Hafta İçi: <?php echo e($contactData['working_hours_weekdays'] ?? '09:00 - 18:00'); ?>

                </div>
                <?php if(!empty($contactData['working_hours_saturday'])): ?>
                    <div class="text-xs font-semibold text-gray-600 mt-0.5">
                        Cumartesi: <?php echo e($contactData['working_hours_saturday']); ?>
        ...
        <div class="bg-gradient-to-br from-blue-50 to-white p-5 rounded-2xl border border-blue-100/80 shadow-sm flex items-start gap-4 transition hover:shadow-md">
            ...
            <div>
                ...
                <div class="text-sm font-bold text-gray-800 mt-0.5 whitespace-pre-line">
                    <?php echo e($contactData['address'] ?? 'AhşapEvim Atölyesi'); ?>

                </div>
                <?php if(!empty($contactData['email'])): ?>
                    <a href="mailto:<?php echo e($contactData['email']); ?>" class="text-xs text-blue-600 hover:underline block mt-1">
                        <?php echo e($contactData['email']); ?>
    ...
    <?php if(!empty($contactData['note'])): ?>
        <div class="bg-orange-50 border-l-4 border-[#C87A53] p-4 rounded-r-xl text-xs text-gray-700 leading-relaxed mb-8">
            <i class="fa-solid fa-info-circle text-[#C87A53] mr-1"></i> <?php echo e($contactData['note']); ?>
    ...
    <?php if(!empty($contactData['map_url'])): ?>
        <div class="mb-8">
            ...
            <div class="w-full h-80 rounded-2xl overflow-hidden border border-gray-200 shadow-sm bg-gray-100 relative">
                <iframe src="<?php echo e($contactData['map_url']); ?>" class="absolute inset-0 w-full h-full border-0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('pages.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u111121823/domains/ahsapevimmanisa.com/public_html/resources/views/pages/contact.blade.php ENDPATH**/ ?>