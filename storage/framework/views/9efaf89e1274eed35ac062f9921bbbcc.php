<?php $__env->startSection('title', 'Giriş Yap — AhşapEvim'); ?>
...
<div class="min-h-[75vh] flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl border border-amber-100 p-8 relative overflow-hidden">
        ...
        <div class="mt-6 text-center text-xs text-gray-500">
            Hesabınız yok mu? 
            <a href="<?php echo e(route('register')); ?>" class="font-bold text-[#C87A53] hover:underline">Hemen Üye Olun</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u111121823/domains/ahsapevimmanisa.com/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>