                ...
                <div class="bg-white rounded-2xl p-6 shadow-sm border border-amber-100">
                    ...
                    <div class="pt-6 grid grid-cols-3 gap-2 text-center relative">
                        ...
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm mb-2 shadow-sm <?php echo e(in_array($order->status, ['paid', 'preparing', 'shipped', 'completed']) ? 'bg-green-600 text-white' : 'bg-gray-200 text-gray-500'); ?>">
                        ...
                        <!-- Step 2 -->
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm mb-2 shadow-sm <?php echo e(in_array($order->status, ['shipped', 'completed']) ? 'bg-blue-600 text-white' : 'bg-gray-200 text-gray-500'); ?>">
                        ...
                        <!-- Step 3 -->
                        <div class="flex flex-col items-center">
                            <div class="w-10 h-10 rounded-full flex items-center justify-center font-bold text-sm mb-2 shadow-sm <?php echo e($order->status === 'completed' ? 'bg-purple-600 text-white' : 'bg-gray-200 text-gray-500'); ?>">
                                        ...
                                        <div>
                                            ...
                                            <?php if($fImg || $bImg): ?>
                                                <div class="mt-1 flex items-center gap-2">
                                                    <?php if($fImg): ?>
                                                        <a href="<?php echo e(str_starts_with($fImg, 'http') ? $fImg : url($fImg)); ?>" target="_blank" class="inline-flex items-center gap-1 bg-amber-50 text-amber-900 border border-amber-200 text-[10px] font-bold px-2 py-0.5 rounded">
                                                            <i class="fa-solid fa-image text-amber-600"></i> Ön Yüz
                                                        </a>
                                                    <?php endif; ?>
                                                    <?php if($bImg): ?>
                                                        <a href="<?php echo e(str_starts_with($bImg, 'http') ? $bImg : url($bImg)); ?>" target="_blank" class="inline-flex items-center gap-1 bg-emerald-50 text-emerald-900 border border-emerald-200 text-[10px] font-bold px-2 py-0.5 rounded">
                                                            <i class="fa-solid fa-image text-emerald-600"></i> Arka Yüz
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
