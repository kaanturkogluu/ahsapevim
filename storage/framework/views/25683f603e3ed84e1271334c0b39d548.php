<?php $__env->startSection('title', 'Anasayfa Görselleri Yönetimi - AhşapEvim Admin'); ?>

<?php $__env->startSection('header', 'Anasayfa Görselleri Yönetimi'); ?>
...
<div class="space-y-6">
    ...
    <div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
        ...
        <div id="addBannerSection" class="hidden bg-amber-50/60 p-5 rounded-xl border border-amber-200/80 mb-6">
            ...
            <form action="<?php echo e(route('admin.banners.store')); ?>" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <?php echo csrf_field(); ?>
                <div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="bg-gray-50 rounded-xl border border-gray-200 overflow-hidden flex flex-col justify-between shadow-xs group hover:border-[#C87A53] transition">
                    ...
                    <div class="relative h-56 bg-stone-200 overflow-hidden flex items-center justify-center p-2">
                        <img src="<?php echo e($banner->image_url); ?>" alt="<?php echo e($banner->title); ?>" class="w-full h-full object-cover rounded-lg group-hover:scale-105 transition-transform duration-300">
                        <div class="absolute top-3 left-3 bg-black/70 text-white px-2.5 py-1 rounded-full text-[11px] font-bold backdrop-blur-xs flex items-center gap-1">
                            <i class="fa-solid fa-sort"></i> SIRA #<?php echo e($banner->order); ?>
                    ...
                    <!-- Card Body / Edit Form -->
                    <form action="<?php echo e(route('admin.banners.update', $banner->id)); ?>" method="POST" enctype="multipart/form-data" class="p-4 space-y-3 bg-white flex-grow flex flex-col justify-between">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-3">
                            <div>
                                ...
                                <input type="text" name="title" value="<?php echo e($banner->title); ?>" class="w-full text-xs font-semibold border-gray-300 rounded-lg p-2 border focus:border-[#C87A53] outline-none">
                            </div>

                            <div class="grid grid-cols-2 gap-2 items-center">
                                <div>
                                    <label class="block text-[11px] font-bold text-gray-500 uppercase">Sıra No</label>
                                    <input type="number" name="order" value="<?php echo e($banner->order); ?>" min="1" class="w-full text-xs font-bold border-gray-300 rounded-lg p-2 border focus:border-[#C87A53] outline-none">
                                </div>
                                <div class="pt-4">
                                    <label class="flex items-center gap-2 text-xs font-bold text-gray-700 cursor-pointer select-none">
                                        <input type="checkbox" name="is_active" value="1" <?php echo e($banner->is_active ? 'checked' : ''); ?> class="w-4 h-4 text-[#C87A53] rounded border-gray-300">
                        ...
                        <div class="flex items-center justify-between gap-2 pt-3 border-t border-gray-100">
                            ...
                            <button type="button" onclick="confirmDeleteBanner(<?php echo e($banner->id); ?>, '<?php echo e(e($banner->title)); ?>')" class="py-1.5 px-3 bg-rose-50 hover:bg-rose-100 text-rose-700 font-bold text-xs rounded-lg transition inline-flex items-center gap-1">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ahsapevim\resources\views\admin\banners\index.blade.php ENDPATH**/ ?>