...
<div class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm max-w-5xl">
    ...
    <form action="<?php echo e(route('admin.pages.store')); ?>" method="POST" id="createPageForm">
        ...
        <div class="mb-6">
            ...
            <textarea id="pageContent" name="content" class="hidden"><?php echo e(old('content')); ?></textarea>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ahsapevim\resources\views/admin/pages/create.blade.php ENDPATH**/ ?>