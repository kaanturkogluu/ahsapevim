...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Yönetim'); ?> — Ahşap Evim Admin</title>
    <!-- Favicon -->
    ...
    <aside id="adminSidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-3 space-y-0.5 px-2">
            ...
            <a href="<?php echo e(route('admin.revenue.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.revenue*') ? 'active text-white' : ''); ?>">
                <i class="fa-solid fa-chart-line w-4 text-center text-amber-400"></i>
                <span class="nav-label">Gelir Tablosu</span>
            </a>

            <a href="<?php echo e(url('/yonetim/siparisler')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->is('yonetim/siparisler*') ? 'active text-white' : ''); ?>">
            ...
            <a href="<?php echo e(url('/yonetim/urunler')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->is('yonetim/urunler*') ? 'active text-white' : ''); ?>">
                <i class="fa-solid fa-box w-4 text-center text-blue-400"></i>
                <span class="nav-label">Ürünler</span>
            </a>

            <a href="<?php echo e(url('/yonetim/kategoriler')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->is('yonetim/kategoriler*') ? 'active text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.merchant.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->is('yonetim/merchant-center*') ? 'active text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.shipping_companies.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.shipping_companies*') ? 'active text-white' : ''); ?>">
                <i class="fa-solid fa-truck-fast w-4 text-center text-orange-400"></i>
                <span class="nav-label">Kargo Şirketleri</span>
            </a>

            <a href="<?php echo e(route('admin.email_templates.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.email_templates*') ? 'active text-white' : ''); ?>">
                <i class="fa-solid fa-envelope-open-text w-4 text-center text-yellow-400"></i>
                <span class="nav-label">E-Posta Şablonları</span>
            </a>

            <a href="<?php echo e(route('admin.mail_logs.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.mail_logs*') ? 'active text-white' : ''); ?>">
                <i class="fa-solid fa-envelope-circle-check w-4 text-center text-amber-400"></i>
                <span class="nav-label">E-Posta Logları</span>
            </a>

            <a href="<?php echo e(route('admin.sms_logs.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.sms_logs*') ? 'active text-white' : ''); ?>">
            ...
            <a href="<?php echo e(url('/yonetim/sayfalar')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->is('yonetim/sayfalar*') ? 'active text-white' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.banners.index')); ?>"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white <?php echo e(request()->routeIs('admin.banners*') ? 'active text-white' : ''); ?>">
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <header class="bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between gap-4 flex-shrink-0 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-base font-bold text-gray-800 leading-tight"><?php echo $__env->yieldContent('header', 'Yönetim Paneli'); ?></h1>
...
<?php /**PATH /home/u111121823/domains/ahsapevimmanisa.com/public_html/resources/views/layouts/admin.blade.php ENDPATH**/ ?>