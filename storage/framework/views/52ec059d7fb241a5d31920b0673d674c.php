...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" id="phone" name="phone" placeholder="Örn: 05551234567" value="<?php echo e(old('phone', auth()->user() ? auth()->user()->phone : '')); ?>" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C87A53] focus:border-[#C87A53] transition">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <input type="text" id="identity_number" name="identity_number" maxlength="11" placeholder="11 haneli T.C. Kimlik No" value="<?php echo e(old('identity_number')); ?>" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C87A53] focus:border-[#C87A53] transition">
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-8 border-t border-gray-100 pt-6">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <label class="relative border-2 border-[#C87A53] bg-orange-50/40 p-4 rounded-xl cursor-pointer flex items-center gap-3 transition hover:shadow-sm">
                                    <input type="radio" name="payment_method" value="card" checked class="text-[#C87A53] focus:ring-[#C87A53] w-4 h-4">
                                    <div>
                                ...
                                <!-- Option 2: Kapıda Ödeme / Havale -->
                                <label class="relative border border-gray-200 hover:border-gray-300 p-4 rounded-xl cursor-pointer flex items-center gap-3 transition">
                                    <input type="radio" name="payment_method" value="cod" class="text-[#C87A53] focus:ring-[#C87A53] w-4 h-4">
                                    <div>
                                        <span class="block text-sm font-extrabold text-gray-800 flex items-center gap-1.5">
                                            <i class="fa-solid fa-hand-holding-dollar text-emerald-600"></i> Kapıda Ödeme / Havale
                                        </span>
                                        <span class="block text-[11px] text-gray-500 mt-0.5">Teslimatta Kart veya Nakit</span>
                                    </div>
                                </label>
                            </div>
                        </div>

                        <button type="submit" class="w-full md:w-auto bg-[#C87A53] hover:bg-[#A65F38] text-white font-bold py-3.5 px-8 rounded-xl transition shadow-md flex items-center justify-center gap-2 text-base">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ahsapevim\resources\views/checkout/index.blade.php ENDPATH**/ ?>