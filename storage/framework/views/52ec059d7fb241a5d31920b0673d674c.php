...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            <div>
                                ...
                                <input type="text" id="phone" name="phone" placeholder="Örn: 05551234567" value="<?php echo e(old('phone')); ?>" required class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#C87A53] focus:border-[#C87A53] transition">
