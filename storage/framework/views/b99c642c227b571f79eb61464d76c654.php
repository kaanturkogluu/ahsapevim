                ...
                <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50/60 transition">
                        ...
                        <td class="py-4 text-center" data-label="Durum">
                            ...
                            <?php else: ?>
                                <span class="px-2.5 py-1 bg-red-100 text-red-700 rounded-full font-bold text-[10px]">
                                    İptal / <?php echo e($order->payment_error_reason ?: 'Başarısız'); ?>
                        ...
                        <td class="py-4 text-right space-x-1 whitespace-nowrap" data-label="İşlem">
                            ...
                            <button type="button" onclick="openDeleteOrderModal(<?php echo e($order->id); ?>, 'Sipariş #<?php echo e($order->id); ?> (<?php echo e($order->name); ?>)')" class="py-1.5 px-2.5 bg-rose-50 text-rose-600 hover:bg-rose-100 font-bold text-xs rounded-lg transition inline-flex items-center gap-1" title="Admin şifresi ile siparişi sil">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u111121823/domains/ahsapevimmanisa.com/public_html/resources/views/admin/orders/index.blade.php ENDPATH**/ ?>