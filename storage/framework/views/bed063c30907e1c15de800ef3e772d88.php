            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6" id="favoritesGrid">
                <?php $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="product-card group relative flex flex-col justify-between" id="favCard-<?php echo e($product->id); ?>">
                        ...
                        <a href="<?php echo e($product->url); ?>" class="block p-4">
                        ...
                        <div class="p-4 pt-0">
                            <a href="<?php echo e($product->url); ?>" class="w-full py-2.5 bg-amber-50 hover:bg-[#C87A53] text-[#C87A53] hover:text-white font-bold text-xs rounded-xl transition flex items-center justify-center gap-1.5 border border-amber-200 hover:border-[#C87A53]">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ahsapevim\resources\views\favorites\index.blade.php ENDPATH**/ ?>