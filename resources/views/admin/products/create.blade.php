            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-3 gap-3">
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order') }}" min="1" placeholder="Otomatik" class="w-full text-sm border-gray-300 rounded-lg p-2.5 border focus:border-brand focus:ring-0 outline-none" title="Boş bırakılırsa en sona otomatik atanır">
                    </div>
                </div>
