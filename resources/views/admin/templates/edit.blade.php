                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <select name="wood_type" id="woodTypeSelect" required class="w-full text-sm border-gray-300 rounded-lg p-2.5 border focus:border-brand focus:ring-0 outline-none bg-white">
                                <option value="Ceviz" {{ $template->wood_type == 'Ceviz' ? 'selected' : '' }}>Masif Ceviz (Koyu)</option>
                                <option value="Meşe" {{ $template->wood_type == 'Meşe' ? 'selected' : '' }}>Masif Meşe (Orta)</option>
                                <option value="Çam" {{ $template->wood_type == 'Çam' ? 'selected' : '' }}>Doğal Çam (Açık)</option>
                                <option value="Kiraz" {{ $template->wood_type == 'Kiraz' ? 'selected' : '' }}>Masif Kiraz (Kızıl)</option>
                                <option value="Ham" {{ $template->wood_type == 'Ham' ? 'selected' : '' }}>Ham Ahşap</option>
                            </select>
                        </div>
                    </div>
                </div>
