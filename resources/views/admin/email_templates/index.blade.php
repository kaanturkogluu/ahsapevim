...
@section('header', 'E-Posta Şablon Yönetimi')
                ...
                @forelse($templates as $index => $template)
                    <tr class="hover:bg-gray-50/60 transition">
                        ...
                        <td class="py-4">
                            ...
                            <div class="text-xs font-mono text-gray-400 mt-0.5">{{ $template->slug }}</div>
                        </td>
                        ...
                        <td class="py-4 text-right space-x-2">
                            ...
                            <a href="{{ route('admin.email_templates.edit', $template->id) }}" class="py-1.5 px-3 bg-[#C87A53] hover:bg-[#A65F38] text-white font-bold text-xs rounded-lg transition inline-flex items-center gap-1 shadow-sm">
