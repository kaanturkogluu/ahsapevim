...
@section('title', 'Kayıt Ol — AhşapEvim')
    ...
    <div class="max-w-md w-full bg-white rounded-2xl shadow-xl border border-amber-100 p-8 relative overflow-hidden">
        ...
        <form action="{{ route('register.post') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="name" required value="{{ old('name') }}" class="w-full text-sm border-gray-300 rounded-xl p-3 border focus:border-brand focus:ring-0 outline-none transition" placeholder="Ahmet Yılmaz">
            </div>
        ...
        <div class="mt-6 text-center text-xs text-gray-500">
            ...
            <a href="{{ route('login') }}" class="font-bold text-[#C87A53] hover:underline">Giriş Yapın</a>
        </div>
    </div>
</div>
@endsection