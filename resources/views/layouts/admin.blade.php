    ...
    <aside id="adminSidebar"
        ...
        <nav class="flex-1 overflow-y-auto py-3 space-y-0.5 px-2">
            ...
            <a href="{{ url('/yonetim/3d-sablonlar') }}"
               class="nav-item flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-[#3D332B] transition-colors text-sm font-medium text-gray-300 hover:text-white {{ request()->is('yonetim/3d-sablonlar*') ? 'active text-white' : '' }}">
