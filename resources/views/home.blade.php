...
<head>
    ...
    <style>
        body { 
            ...
            overflow: hidden; /* Prevent body scroll, use snap container */
        }
...
<body class="text-gray-800 selection:bg-brand selection:text-white">
    ...
    <div class="fixed top-6 left-6 lg:top-8 lg:left-14 z-50 flex items-center gap-3 pointer-events-auto">
        <div class="w-10 h-10 rounded-xl bg-brand flex items-center justify-center text-white font-black text-xl shadow-lg shadow-brand/25">A</div>
        <div class="flex flex-col">
            <span class="text-xl font-extrabold tracking-tight text-gray-900 leading-none">Ahşap<span class="text-brand">Evim</span></span>
            <span class="text-[10px] font-semibold text-gray-400 tracking-wider uppercase mt-1">Galeri Kalitesinde Masif Tasarım</span>
        </div>
    </div>
    ...
    <div class="fixed right-3 top-1/2 -translate-y-1/2 z-50 flex flex-col items-center gap-3.5 bg-white/95 backdrop-blur-md py-6 px-2.5 rounded-full shadow-2xl border border-gray-200/80">
        <button onclick="scrollToStep(1)" id="dot-1" class="step-dot w-4 h-4 rounded-full bg-brand scale-125 shadow-sm" title="1. Adım: Masif Ahşap Gövde"></button>
        <button onclick="scrollToStep(2)" id="dot-2" class="step-dot w-3.5 h-3.5 rounded-full bg-gray-300 hover:bg-gray-400" title="2. Adım: Fotoğraflarınızı Yükleyin"></button>
        <button onclick="scrollToStep(3)" id="dot-3" class="step-dot w-3.5 h-3.5 rounded-full bg-gray-300 hover:bg-gray-400" title="3. Adım: 360° Çift Taraflı Sunum"></button>
    </div>
    ...
    <div id="scroll-container" class="h-screen w-full overflow-y-auto snap-y snap-mandatory scroll-smooth relative">
        ...
        <div class="w-full lg:w-1/2 z-10 px-6 lg:pl-16 lg:pr-10">
            ...
            <section id="step-1" class="step-section h-screen snap-start snap-always flex flex-col justify-center py-12" data-step="1">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-brand/10 text-brand text-xs font-bold rounded-full mb-5 w-max shadow-sm">
                    <span class="w-2 h-2 rounded-full bg-brand animate-pulse"></span> 1. ADIM — DOĞAL AHŞAP KASNAK
                </div>
                <h1 class="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight mb-5">
                    Ustalıkla İşlenen <br><span class="text-brand underline decoration-brand/30 underline-offset-8">Doğal Ahşabın Zamansız Zarafeti</span>
                </h1>
                <p class="text-base lg:text-lg text-gray-600 leading-relaxed mb-6 max-w-xl">
                    Anılarınızı sıradan çerçevelere değil, özenle tasarlanmış masif ahşap çerçevelere taşıyın. Doğal dokusu, modern tasarımı ve kaliteli işçiliğiyle yaşam alanlarınıza sıcaklık ve karakter katın. Tarzınıza en uygun rengi seçin, eviniz için kusursuz çerçeveyi keşfedin.
                </p>
                ...
                <div class="bg-white p-5 rounded-2xl border border-gray-200/80 shadow-sm max-w-xl">
                    <div class="flex items-center justify-between mb-3">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider">Masif Ahşap Rengini Seçin</label>
                        <span id="activeWoodLabel" class="text-xs font-bold text-brand">Doğal Ceviz</span>
                    </div>
                    <div class="grid grid-cols-3 gap-3">
                        <button onclick="setWoodColor('#4a2e1b', 'Doğal Ceviz')" id="btn-wood-0" class="py-3 px-4 rounded-xl border-2 border-brand bg-[#4a2e1b] text-white text-xs font-bold shadow-sm transition hover:scale-105 flex items-center justify-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full bg-amber-400"></span>
                            <span>Doğal Ceviz</span>
                        </button>
                        <button onclick="setWoodColor('#8b5a2b', 'Sıcak Meşe')" id="btn-wood-1" class="py-3 px-4 rounded-xl border border-gray-300 bg-[#8b5a2b] text-white text-xs font-bold shadow-sm transition hover:scale-105 flex items-center justify-center gap-2">
                            <span class="w-2.5 h-2.5 rounded-full bg-amber-200"></span>
                            <span>Sıcak Meşe</span>
                        </button>
                        <button onclick="setWoodColor('#2b1d0c', 'Asil Wenge')" id="btn-wood-2" class="py-3 px-4 rounded-xl border border-gray-300 bg-[#2b1d0c] text-white text-xs font-bold shadow-sm transition hover:scale-105 flex items-center justify-center gap-2">
            ...
            <section id="step-2" class="step-section h-screen snap-start snap-always flex flex-col justify-center py-12" data-step="2">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-blue-100 text-blue-700 text-xs font-bold rounded-full mb-5 w-max shadow-sm">
                    <span class="w-2 h-2 rounded-full bg-blue-600"></span> 2. ADIM — KİŞİSELLEŞTİRME & ÖNİZLEME
                </div>
                <h2 class="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight mb-5">
                    En Güzel Anılarınız, <br><span class="text-blue-600 underline decoration-blue-500/30 underline-offset-8">Size Özel Bir Tasarımda</span> Hayat Bulsun
                </h2>
                <p class="text-base lg:text-lg text-gray-600 leading-relaxed mb-6 max-w-xl">
                    Çift taraflı tasarımı sayesinde iki farklı fotoğrafınızı tek çerçevede sergileyin. Fotoğraflarınızı yükleyin, çerçevenizi her açıdan inceleyin ve eviniz için en özel görünümü oluşturun.
                </p>

                <!-- Dual Photo Upload Box (Professional e-commerce style) -->
                <div class="bg-white p-5 rounded-2xl border border-gray-200/80 shadow-sm max-w-xl">
                    <div class="flex items-center justify-between mb-3">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider">Çift Taraflı Galeri Önizlemesi (2 Fotoğraf)</label>
                        <span class="text-[11px] font-semibold text-blue-600 bg-blue-50 px-2.5 py-0.5 rounded-md">3D Derinlikli Hazne</span>
                    </div>
                    
                    <div class="grid grid-cols-2 gap-3">
                        <!-- Photo 1 (Front Face) -->
                        <label for="step2PhotoInput1" class="flex flex-col items-center justify-center border-2 border-dashed border-blue-300 bg-blue-50/40 hover:bg-blue-50/80 hover:border-blue-500 rounded-xl p-3 cursor-pointer transition group relative overflow-hidden h-28">
                            <div id="preview-container-1" class="flex flex-col items-center justify-center text-center">
                                <div class="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center text-blue-600 mb-1.5 group-hover:scale-110 transition shadow-sm">
                            ...
                            <img id="preview-img-1" class="hidden absolute inset-0 w-full h-full object-cover rounded-xl" />
                            <input type="file" id="step2PhotoInput1" class="hidden" accept="image/*">
                        </label>

                        <!-- Photo 2 (Back Face) -->
                        <label for="step2PhotoInput2" class="flex flex-col items-center justify-center border-2 border-dashed border-blue-300 bg-blue-50/40 hover:bg-blue-50/80 hover:border-blue-500 rounded-xl p-3 cursor-pointer transition group relative overflow-hidden h-28">
                            ...
                            <img id="preview-img-2" class="hidden absolute inset-0 w-full h-full object-cover rounded-xl" />
                            <input type="file" id="step2PhotoInput2" class="hidden" accept="image/*">
                        </label>
                    </div>

                    <div id="step2UploadSuccess" class="hidden mt-3 p-2.5 bg-green-50 border border-green-200 rounded-lg text-green-700 text-xs font-semibold flex items-center gap-2">
                        <i class="fa-solid fa-circle-check"></i>
                        <span id="step2SuccessText">Fotoğraflarınız işlendi! 3. adımda 360° dönerken inceleyebilirsiniz.</span>
                    </div>
                </div>

                <div class="mt-8 flex items-center gap-2 text-xs font-bold text-gray-400 uppercase tracking-wider">
                    <span>3. Adım: 360° Dönen Çift Taraflı Sunum</span>
                    <i class="fa-solid fa-arrow-down animate-bounce text-blue-500"></i>
                </div>
            </section>
            ...
            <section id="step-3" class="step-section h-screen snap-start snap-always flex flex-col justify-center py-12" data-step="3">
                <div class="inline-flex items-center gap-2 px-3.5 py-1.5 bg-amber-100 text-amber-700 text-xs font-bold rounded-full mb-5 w-max shadow-sm">
                    <span class="w-2 h-2 rounded-full bg-amber-600"></span> 3. ADIM — 360° DÖNEN DENEYİM & SİPARİŞ
                </div>
                <h2 class="text-4xl lg:text-5xl font-extrabold text-gray-900 tracking-tight leading-tight mb-5">
                    İki Farklı Anı, <br><span class="text-amber-600 underline decoration-amber-500/30 underline-offset-8">Tek Bir Çerçevede 360° Şıklık</span>
                </h2>
                <p class="text-base lg:text-lg text-gray-600 leading-relaxed mb-6 max-w-xl">
                    En değerli iki fotoğrafınızı tek bir çerçevede buluşturun. Çift taraflı dönebilen tasarımı sayesinde dilediğiniz an farklı anılarınızı sergileyin. Doğal masif ahşap, özenli işçilik ve ücretsiz kargo ile şimdi keşfedin.
                </p>

                <!-- Clean E-Commerce CTA Button -->
                <div class="mt-2">
                    <a href="/products" class="inline-flex items-center justify-center gap-3 py-4 px-8 bg-brand hover:bg-brand-dark text-white font-extrabold text-base rounded-2xl shadow-xl shadow-brand/25 hover:shadow-2xl hover:shadow-brand/40 transition-all transform hover:-translate-y-0.5">
                        <span>Ürünleri Keşfet</span>
    ...
    <div class="hidden lg:flex w-[44vw] max-w-[620px] h-[82vh] fixed right-10 top-1/2 -translate-y-1/2 z-20 items-center justify-center pointer-events-auto">
        <div class="w-full h-full bg-gradient-to-b from-white via-[#fcfdfe] to-[#f1f5f9] rounded-3xl border border-gray-200/80 shadow-2xl overflow-hidden relative">
            <!-- 3D Viewport -->
            <div id="showcase3D" class="w-full h-full cursor-grab active:cursor-grabbing"></div>

            <!-- Active Step Status Badge on Canvas -->
            <div class="absolute top-6 left-6 z-10 bg-white/95 backdrop-blur-md px-3.5 py-2 rounded-xl shadow-sm border border-gray-200/80 flex items-center gap-2">
            ...
            <!-- Rotate & Zoom Hint -->
            <div class="absolute bottom-6 left-6 z-10 bg-black/65 backdrop-blur-md text-white px-3.5 py-2 rounded-xl text-[11px] font-medium flex items-center gap-2 pointer-events-none shadow-lg">
            ...
            <div class="absolute top-6 right-6 z-10">
                <button onclick="resetCameraView()" class="w-9 h-9 bg-white/95 hover:bg-white text-gray-600 hover:text-gray-900 rounded-xl shadow-sm border border-gray-200/80 flex items-center justify-center transition" title="Kamerayı Sıfırla">
